...
import co.edu.unicauca.asae.jpa_hexagonal_.infraestructura.output.persistencia.mappers.LocationMapper;
...
public class LocationRestController {
    ...
    private final LocationMapper objMapeador;
    ...
    public ResponseEntity<LocationDTORespuesta> create(@RequestBody @Valid LocationDTOPeticion objLocation) {
        ...
        ResponseEntity<LocationDTORespuesta> objRespuesta = new ResponseEntity<LocationDTORespuesta>(
                objMapeador.mappearDeLocationsARespuesta(objLocationCreado), HttpStatus.CREATED); // Responder(objLocation_creado,HttpStatus)
        return objRespuesta;
    }
