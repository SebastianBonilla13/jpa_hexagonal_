package co.edu.unicauca.asae.jpa_hexagonal_.infraestructura.output.controladorExcepciones.estructuraExcepciones;
...
public enum CodigoError {
    ...
    /* CORREO_ELECTRONICO_DUPLICADO("GC-007", "Correo electronico duplicado"); */
