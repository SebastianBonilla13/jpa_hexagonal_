...
INSERT INTO `docente` (`id`, `oficina_id`, `nombre`, `apellido`, `correo`) VALUES (NULL, NULL, 'Jhon', 'Masso', 'jmasso@unicauca.edu.co'), (NULL, NULL, 'Jimena', 'Timana', 'jtimana@unicauca.edu